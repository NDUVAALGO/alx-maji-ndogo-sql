...
As a young Kenyan passionate about leveraging data for impactful solutions, this project resonates deeply with my personal and professional aspirations. Growing up in a region where water access is often limited, I have firsthand experience of the challenges faced by communities like Maji Ndogo. My background in Mathematics and Computer Science has equipped me with the skills to tackle these issues through data-driven approaches.
